	 ...
	 <div class="w3-row">
	 	...
	 	<div class="col-md-6">
	 		...
	 		<table class="table table-hover table-bordered" id="table">
	 			...
	 			<tbody>
	 				...
	 				$get = $db->query("SELECT * FROM categoria");
	 	...
	 	<div class="col-md-6">
	 		<div class="panel panel-primary">
	 			<div class="panel-heading">Adicionar novo produto</div>
	 			<div class="panel-body">
	 				<form method="post">
	 					<div class="form-group">
	 						<label class="control-label">Nome da categoria</label>
	 						<input type="text" name="categoria" class="form-control" placeholder="Enter categoria name">
	 					</div>
	 					...
	 					<?php 
                          if(isset($_POST['submit'])){
                          	...
                          	$query = $db->query("INSERT INTO categoria(name)VALUES('$name')");

                          	if($query){ ?>
                             <script>alert('Product Added. Click OK to close dialogue.')</script>
                          	<?php 
                          	header('refresh: 3');
                            }
                          }
